...
def check_longest_module_sequence(module_list):
    """
    Checks which is the longest sequence of complex numbers with a lenght bigger than 1 with the same
    modulus
...
def run_menu():
    """
    Runs the menu untill the user selects the exit input ("x")
